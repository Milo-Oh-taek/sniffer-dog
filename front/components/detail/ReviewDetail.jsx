...
import { postReviewLike, postReviewDislike } from "../../store/thunk/reviewThunk";

import Card from "react-bootstrap/Card";

import StarRatingComponent from "react-star-rating-component";

const ReviewDetail = ({ id, review, sortby, reviewList, reviewSize, userInfo }) => {
	...
	const likeHandler = (reviewId) => {
		...
		dispatch(
			postReviewLike({
				...
				sortby,
				userId: userInfo.id,
				page: reviewList.length / reviewSize,
			}),
		);
	};
